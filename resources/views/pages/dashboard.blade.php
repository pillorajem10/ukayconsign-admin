    ...
    <div class="dashboard-page">
        ...
        <div class="small-section-container">
            ...
            <div class="dashboard-container billing-container">
                <h2 class="welcome-message">Latest Billings</h2>
        ...
        <div class="small-section-container">
                ...
                <table class="earnings-table">
                    <thead class="table-header">
                        <tr>
                            ...
                            <th class="header-cell">For Today</th>
                    ...
                    <tbody class="table-body">
                        @foreach ($storeEarnings as $storeId => $earnings)
                            <tr class="table-row">
                                ...
                                <td class="data-cell" data-label="For Today">₱{{ number_format($earnings['total_today'], 2) }}</td>
            ...
            <div class="dashboard-container">
                <h2 class="welcome-message">Stores</h2>
